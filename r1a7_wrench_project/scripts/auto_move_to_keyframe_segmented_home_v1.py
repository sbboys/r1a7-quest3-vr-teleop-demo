...
# Local indices in the 14-DoF arm vector.
LEFT_SHOULDER = [0, 1, 2]
LEFT_ELBOW = [3]
LEFT_WRIST = [4, 5, 6]
...
class AutoKeyframeMover:
    ...
    def execute_segment(
        ...
        # ====================================================
        # Segment hold / reach verification
        # ====================================================
    ...
    def execute(
        ...
        try:
            ...
            # =================================================
            # Execute all segments without releasing LowCmd.
            # =================================================
