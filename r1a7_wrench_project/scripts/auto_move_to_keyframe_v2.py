...
class AutoKeyframeMoverV2:
    ...
    def preflight(
        ...
        if verbose:
            ...
            print(
                "R1-A7 AUTO-HOME V2 ADAPTIVE RECOVERY PRE-FLIGHT"
            )
    ...
    def execute(
        ...
        print(
            "Type RECOVER HOME V2 exactly to continue."
        )
...
def build_parser():
    ...
    p = argparse.ArgumentParser(
        description=(
            "R1-A7 AUTO HOME V2 with "
            "measured-state adaptive recovery"
        )
    )
